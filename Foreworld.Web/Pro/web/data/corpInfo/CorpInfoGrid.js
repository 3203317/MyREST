...
define(["jquery",
	...
	var _grid = function($params){
		...
		__grid.setHeader("ID,#master_checkbox,企业名称,企业名称(英文),企业信息,创建时间,创建人,状态",null,[null,"text-align:left;"]);
		__grid.setInitWidths("30,40,150,150,300,120,100,100");
		__grid.setColAlign("center,center,left,left,left,left,left,left");
		__grid.setColTypes("cntr,ch,ro,ro,ro,ro,ro,ro");
		__grid.setColSorting("int,intr,str,str,str,date,str,str");
		...
		var __ajax = function(){
			$.ajax({
				type: "get",
				url: "../../../Api.ashx?command=dataSource&name=0BB6B24B09BC40938C98A9608A60EA1D",
				dataType: "json",
				async: true,
